...
public class system {
	...
	private JTextArea desciptionEditField;
		...
		for (int i = 0; i <  owners.get(currentUserID).playgrounds.size(); i++) {
			...
			editBtn.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					System.out.println("Current playground index: " + playgroundIndex);
					String size = ""+owners.get(currentUserID).playgrounds.get(playgroundIndex).getSize();
					String price = ""+owners.get(currentUserID).playgrounds.get(playgroundIndex).getPrice();
					String cancel = ""+owners.get(currentUserID).playgrounds.get(playgroundIndex).getCancellationPeriod();
					nameEditField.setText(owners.get(currentUserID).playgrounds.get(playgroundIndex).getName());
					desciptionEditField.setText(owners.get(currentUserID).playgrounds.get(playgroundIndex).getDescription());
					sizeEditField.setText(size);
					priceEditField.setText(price);
					locationEditField.setText(owners.get(currentUserID).playgrounds.get(playgroundIndex).getLocation());
					cancelEditField.setText(cancel);
					for (int j = 0; j <  owners.get(currentUserID).playgrounds.get(playgroundIndex).slots.size(); j++) {
						JLabel slotLabel = new JLabel("  slot #"+(j+1) + "   From: " + owners.get(currentUserID).playgrounds.get(playgroundIndex).slots.get(j).getFrom() + "   To: " + owners.get(currentUserID).playgrounds.get(playgroundIndex).slots.get(j).getTo());
						...
						deleteBtn.setBounds(238, 12+(40 * j), 72, 23);
						int slotIndex = j;
						deleteBtn.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
								System.out.println("Slot index: " + slotIndex);
								System.out.println("Slot size before: " + owners.get(currentUserID).playgrounds.get(playgroundIndex).slots.size());
								owners.get(currentUserID).playgrounds.get(playgroundIndex).slots.remove(slotIndex);
								System.out.println("Slot size after: " + owners.get(currentUserID).playgrounds.get(playgroundIndex).slots.size());
								slotsEditPanel.removeAll();
								for (int j = 0; j <  owners.get(currentUserID).playgrounds.get(playgroundIndex).slots.size(); j++) {
									JLabel slotLabel = new JLabel("  slot #"+(j+1) + "   From: " + owners.get(currentUserID).playgrounds.get(playgroundIndex).slots.get(j).getFrom() + "   To: " + owners.get(currentUserID).playgrounds.get(playgroundIndex).slots.get(j).getTo());
									slotLabel.setFont(new Font("Showcard Gothic", Font.PLAIN, 14));
								...
								slotsEditPanel.setPreferredSize(new Dimension(100, 44*owners.get(currentUserID).playgrounds.get(playgroundIndex).slots.size())); // Increases the size of the panel
			...
			editAddBtn.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					if (toEditField.getText().equals("") || fromEditField.getText().equals("")){
						errorEditMsg.setText("Enter the From and To field");
					} else {
						errorEditMsg.setText(""); // rests the error message
						slot newSlot = new slot(fromEditField.getText(), toEditField.getText());
						owners.get(currentUserID).playgrounds.get(playgroundIndex).addSlot(newSlot);
						// Reset the fields
						slotsEditPanel.removeAll();
						// Refreshes the panel
						for (int j = 0; j <  owners.get(currentUserID).playgrounds.get(playgroundIndex).slots.size(); j++) {
			...
			for (int j = 0; j <  owners.get(currentUserID).playgrounds.get(i).slots.size(); j++) {
				JLabel slotLabel = new JLabel("  slot #"+(j+1) + "   From: " + owners.get(currentUserID).playgrounds.get(i).slots.get(j).getFrom() + "   To: " + owners.get(currentUserID).playgrounds.get(i).slots.get(j).getTo());
				slotLabel.setFont(new Font("Showcard Gothic", Font.PLAIN, 14));
				slotLabel.setBounds(10, 17+(40 * j), 291, 14); // Gap between the labels
			...
			btnUpdateEdit.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (nameEditField.getText().equals("")) {
					...
					} else if (desciptionEditField.getText().equals("")) {
						...
						owners.get(currentUserID).playgrounds.get(playgroundIndex).updateInfo(nameEditField.getText(), desciptionEditField.getText(), locationEditField.getText(), size, cancel, price);
		...
		for (int i = 0; i < owners.get(currentUserID).playgrounds.size(); i++) {
			...
			for (int j = 0; j < owners.get(currentUserID).playgrounds.get(i).slots.size(); j++) {
				if (owners.get(currentUserID).playgrounds.get(i).slots.get(j).isBooked()) {
					JLabel newSlot = new JLabel("Playground #" + (i+1) + "  Slot #" + (j+1) + "- From: " + owners.get(currentUserID).playgrounds.get(i).slots.get(j).getFrom() + "  To: " + owners.get(currentUserID).playgrounds.get(i).slots.get(j).getTo() + "  Player: " + owners.get(currentUserID).playgrounds.get(i).slots.get(j).getPlayer());
					newSlot.setForeground(Color.WHITE);
					newSlot.setFont(new Font("Showcard Gothic", Font.PLAIN, 14));
					newSlot.setBounds(21, 176 +(46*j), 457, 14);
	...
	private void initialize() {
		...
		verificationCodeField.setFont(new Font("Times New Roman", Font.BOLD, 30));
		...
		menuOwnerPanel.setBounds(0, 0, 227, 652);
		...
		editPlaygroundPanel.setBackground(new Color(153, 204, 102));
		...
		playgroundNameLabel_1.setBounds(23, 88, 56, 30);
		...
		lblDescription_1.setBounds(23, 138, 119, 30);
		...
		lblSize_1.setBounds(23, 202, 56, 30);
		...
		lblPricehour.setBounds(23, 243, 119, 30);
		...
		lblCancellationPeriod.setBounds(23, 294, 203, 30);
		...
		playgroundNameLabel_6.setBounds(23, 335, 103, 30);
		...
		playgroundNameLabel_7.setBounds(23, 374, 56, 30);
		...
		nameEditField.setBounds(143, 94, 272, 20);
		...
		sizeEditField.setBounds(143, 208, 72, 20);
		...
		priceEditField.setBounds(143, 249, 103, 20);
		...
		locationEditField.setBounds(143, 341, 272, 20);
		...
		toEditField.setBounds(257, 404, 72, 20);
		...
		fromEditField.setBounds(120, 404, 65, 20);
		editPlaygroundPanel.add(fromEditField);
		
		desciptionEditField = new JTextArea();
		desciptionEditField.setLineWrap(true);
		desciptionEditField.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		desciptionEditField.setBounds(143, 142, 272, 50);
		editPlaygroundPanel.add(desciptionEditField);
		...
		cancelEditField.setBounds(211, 299, 86, 20);
		...
		playgroundNameLabel_7_1.setBounds(66, 399, 56, 30);
		...
		playgroundNameLabel_7_2.setBounds(223, 399, 35, 30);
		editPlaygroundPanel.add(playgroundNameLabel_7_2);
		
		editAddBtn = new JButton("Add");
		editAddBtn.setFont(new Font("Showcard Gothic", Font.PLAIN, 11));
		editAddBtn.setBounds(358, 402, 81, 23);
		...
		playgroundNameLabel_7_1_1.setBounds(307, 294, 56, 30);
		...
		btnUpdateEdit.setBounds(194, 553, 96, 26);
		...
		scrollPane_2.setBounds(106, 440, 329, 61);
		...
		errorEditMsg.setBounds(62, 512, 407, 30);
		...
		scrollPane.setBounds(121, 490, 331, 63);
		...
		btnAddSlot.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (toField.getText().equals("") || fromField.getText().equals("")){
					errorMsgNewPlayground.setText("Enter the From and To field");
				} else {
					errorMsgNewPlayground.setText(""); // rests the error message
					slot newSlot = new slot(fromField.getText(), toField.getText());
					newSlots.add(newSlot); // creates a new slot
					
					JLabel newlabel = new JLabel("slot #"+slotNum + "   From: " + fromField.getText() + "   To: " + toField.getText());
					slotNum++;
					newlabel.setFont(new Font("Showcard Gothic", Font.PLAIN, 12));
					newlabel.setBounds(10, 17+(40 *(newSlots.size()-1)), 291, 14); // Gap between the labels
					newSlotLabels.add(newlabel); // creates a new label for the slot to display
					
					JButton deleteBtn = new JButton("Delete");
					deleteBtn.setFont(new Font("Showcard Gothic", Font.PLAIN, 10));
					deleteBtn.setBounds(238, 12+(40 *(newSlots.size()-1)), 72, 23);
					deleteBtn.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							int index = 0;
							...
							for (int j = 0; j < newSlotLabels.size(); j++) {
								newSlotLabels.get(j).setBounds(10, 17+(40 *j), 291, 14);
								deleteSlotBtns.get(j).setBounds(238, 12+(40 *j), 72, 23);
		...
		btnAddSlot.setBounds(382, 456, 70, 23);
		...
		playgroundNameLabel.setBounds(45, 144, 56, 30);
		...
		lblPricehours.setBounds(45, 298, 124, 30);
		...
		cancellationPeriodLabel.setBounds(45, 349, 195, 30);
		...
		locationLabel.setBounds(45, 395, 98, 30);
		...
		slotsLabel.setBounds(45, 436, 56, 30);
		...
		namePlaygroundField.setBounds(180, 150, 164, 20);
		...
		desciptionPlaygroundField.setBounds(180, 189, 272, 50);
		...
		sizePlaygroundField.setBounds(180, 255, 86, 20);
		...
		pricePlaygroundField.setBounds(179, 304, 86, 20);
		...
		cancellationPlaygroundField.setBounds(250, 352, 60, 20);
		...
		locationPlaygroundField.setBounds(180, 401, 164, 20);
		addPlaygroundOwnerPanel.add(locationPlaygroundField);
		
		fromField = new JTextField();
		fromField.setBounds(180, 457, 60, 20);
		addPlaygroundOwnerPanel.add(fromField);
		fromField.setColumns(10);
		
		toField = new JTextField();
		toField.setColumns(10);
		toField.setBounds(295, 457, 60, 20);
		...
		lblFrom.setBounds(121, 460, 46, 14);
		...
		btnSubmit_2.setBounds(200, 604, 98, 37);
		...
		errorMsgNewPlayground.setBounds(45, 563, 407, 30);
		...
		lblDays.setBounds(320, 354, 46, 21);
